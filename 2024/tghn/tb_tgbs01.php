...
$total_result = mysqli_query($conn, "SELECT COUNT(*) AS total FROM tb_tgbs01");
$total_data = mysqli_fetch_assoc($total_result)['total'];
$total_pages = ceil($total_data / $items_per_page);

$sql_tgbs01 = "SELECT * FROM tb_tgbs01 WHERE 1=1";
if (!empty($search_keyword)) {
    $sql_tgbs01 .= " AND (pengguna LIKE '%$search_keyword%' OR no_hp LIKE '%$search_keyword%')";
}

$sql_tgbs01 .= " ORDER BY pengguna ASC";
$offset = ($current_page - 1) * $items_per_page;
$sql_tgbs01 .= " LIMIT $items_per_page OFFSET $offset";

$result = mysqli_query($conn, $sql_tgbs01) or die(mysqli_error($conn));

$page = isset($_GET['page']) ? intval($_GET['page']) : 1;
?>

<div class="card mt-3 shadow-sm">
    <div class="card-header bg-info text-light">Rekapan Tagihan BS 01</div>
    <div class="card-body">
        <div class="d-flex justify-content-between">
        <div><a href="download_excel_tagihan.php?table=tb_tgbs01" class="btn btn-success">Download Daftar Tagihan</a></div>
        ...
        <input type="hidden" name="table" value="tb_tgbs01">
        <input type="hidden" name="redirect" value="tb_tgbs01.php">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle;">
                                <a href="rincian.php?id=<?= $data['id'] ?>&table=tb_tgbs01"
