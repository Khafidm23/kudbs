...
<div class="card mt-3 shadow-sm">
    ...
    <div class="card-body">
            ...
            <div class="card p-3 mb-3 shadow-sm">
                <form method="POST" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <div>
                            <a href="add2.php?table=tb_hmbs05" class="btn btn-success">Tambah Data</a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <form method="POST" action="del_all.php" onsubmit="return confirmDeleteAll()">
            <input type="hidden" name="table" value="tb_hmbs05">
            <input type="hidden" name="redirect" value="tb_hmbs05.php">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle;">
                                <a href="edit.php?id=<?= $data['id'] ?>&table=tb_hmbs05"
                                    class="btn btn-warning">Edit</a>
                                <a href="delete.php?id=<?= $data['id'] ?>&table=tb_hmbs05" class="btn btn-danger"
