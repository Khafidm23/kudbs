...
// Mulai query SQL
$sql_hmbs02 = "SELECT * FROM tb_hmbs02";
$conditions = [];
...
if (count($conditions) > 0) {
    $sql_hmbs02 .= " WHERE " . implode(" AND ", $conditions);
}

// Hitung total data
$sql_total = str_replace('SELECT *', 'SELECT COUNT(*) AS total', $sql_hmbs02);
$total_result = mysqli_query($conn, $sql_total);
$total_data = mysqli_fetch_assoc($total_result)['total'];
$total_pages = ceil($total_data / $limit);

// Tambahkan urutan dan batasan
$sql_hmbs02 .= " ORDER BY $order_by $order_direction LIMIT $limit OFFSET $offset";
$result = mysqli_query($conn, $sql_hmbs02);
?>
...
<div class="card mt-3 shadow-sm">
    <div class="card-header bg-info text-light">Rekapan HM BS 02</div>
    <div class="card-body">
        <div class="d-flex justify-content-between">
        <div><a href="download_hm.php?table=tb_hmbs02" class="btn btn-success">Download Rekap HM</a></div>
            ...
            <div class="card p-3 mb-3 shadow-sm">
                <form method="POST" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <div>
                            <a href="add2.php?table=tb_hmbs02" class="btn btn-success">Tambah Data</a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <form method="POST" action="del_all.php" onsubmit="return confirmDeleteAll()">
            <input type="hidden" name="table" value="tb_hmbs02">
            <input type="hidden" name="redirect" value="tb_hmbs02.php">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle;">
                                <a href="edit.php?id=<?= $data['id'] ?>&table=tb_hmbs02"
                                    class="btn btn-warning">Edit</a>
                                <a href="delete.php?id=<?= $data['id'] ?>&table=tb_hmbs02" class="btn btn-danger"
