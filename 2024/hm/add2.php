...
$allowed_tables = ['tb_hmbs02', 'tb_hmbs03', 'tb_hmbs04', 'tb_hmbs05']; // Daftar tabel yang diizinkan
                    ...
                    <div class="data-entry">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="harga_hm[]" type="number" value="650000" class="form-control">
                            </div>
    ...
    document.getElementById('jumlah_data').addEventListener('change', function () {
        ...
        for (var i = 0; i < jumlahData; i++) {
            ...
            <div class="row mt-3">
                        ...
                        <div class="col-md-6 mb-3">
                                <label class="form-label">ID :</label>
                                <input name="no_hp[]" type="tel" class="form-control" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Harga / HM :</label>
                                <input name="harga_hm[]" type="number" value="650000" class="form-control">
