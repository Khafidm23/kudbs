...
// Mulai query SQL
$sql_angsuran = "SELECT * FROM tb_angsuran";
$conditions = [];

// Jika tombol cari ditekan, gunakan pencarian tanpa filter bulan dan tahun
if ($is_search) {
    $conditions[] = "(pengguna LIKE '%$search_keyword%' OR tanggal LIKE '%$search_keyword%' OR sumber LIKE '%$search_keyword%' OR keterangan LIKE '%$search_keyword%')";
} else {
...
<div class="card mt-3 shadow-sm">
    <div class="card-header bg-info text-light"><b> Rekapan Angsuran Pengguna </b></div>
    <div class="card-body">
        <div class="d-flex justify-content-between">
        <div><a href="download_angsuran.php?table=tb_angsuran" class="btn btn-success">Download Daftar Angsuran</a></div>
            ...
            <div class="card p-3 mb-3 shadow-sm">
                <form method="POST" style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <div>
                            <a href="add.php?table=tb_angsuran" class="btn btn-success">Tambah Angsuran</a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <form method="POST" action="del_all.php" onsubmit="return confirmDeleteAll()">
            <input type="hidden" name="table" value="tb_angsuran">
            <input type="hidden" name="redirect" value="tb_angsuran.php">
                ...
                <table class="table table-striped table-hover table-bordered">
                    <thead class="table-header table-info">
                        <tr>
                            ...
                            <th style="width: 160px;">Jumlah Angsuran</th>
                            <th>Keterangan</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit.php?id=<?= $data['id'] ?>&table=tb_angsuran"
                                    class="btn btn-warning">Edit</a>
                                <a href="delete.php?id=<?= $data['id'] ?>&table=tb_angsuran" class="btn btn-danger"
