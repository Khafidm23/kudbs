...
$sql_tgpinjaman = "SELECT * FROM tb_tgpinjaman WHERE 1=1";
...
<div class="card mt-3 shadow-sm">
    <div class="card-header bg-info text-light">Rekapan Tagihan Pinjaman Karyawan</div>
    <div class="card-body">
        <div class="d-flex justify-content-between">
        <div><a href="tagihan.php?table=tb_tgpinjaman" class="btn btn-success">Download Tagihan Pinjaman</a></div>
            <div class="col-md-6 mx-auto">
                <form method="GET" action="">
                    <div class="input-group mb-3">
                        <input type="text" name="tcari" class="form-control" placeholder="Masukkan Nama Peminjam!"
        ...
        <input type="hidden" name="table" value="tb_tgpinjaman">
        <input type="hidden" name="redirect" value="tb_tgpinjaman.php">
                ...
                <table class="table table-striped table-hover table-bordered">
                    <thead class="table-header table-info">
                        <tr>
                            ...
                            <th style="vertical-align: middle; width: 100px;">Jumlah Pinjaman</th>
                            <th style="vertical-align: middle; width: 100px;">Jumlah Angsuran</th>
                            <th style="vertical-align: middle; width: 150px;">Sisa Pinjaman</th>
                            <th style="vertical-align: middle;">Keterangan</th>
                            <th style="width: 190px; vertical-align: middle;">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle;"><?= htmlspecialchars($data['pinjaman']) ?></td>
                            <td style="vertical-align: middle;"><?= htmlspecialchars($data['angsuran']) ?></td>
                            <td style="vertical-align: middle;"><?= htmlspecialchars($data['sisa_pinjaman']) ?></td>
                            <td style="vertical-align: middle;"><?= htmlspecialchars($data['keterangan']) ?></td>
                            <td style="vertical-align: middle;">
                                <a href="rincian.php?id=<?= $data['id'] ?>&table=tb_tgpinjaman"
