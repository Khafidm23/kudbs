...
// Hitung total data
$sql_total = "SELECT COUNT(*) AS total FROM helper";
if (count($conditions) > 0) {
...
<div class="card mt-3 shadow-sm">
    <div class="card-header bg-info text-light"><b>Rekapan Gaji Helper</b></div>
    <div class="card-body">
        <div class="d-flex justify-content-between">
        <div><a href="download2.php?table=helper" class="btn btn-success">Download Daftar Gaji</a></div>
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <div>
                            <button class="btn btn-secondary" name="tampilkan_semua" type="submit">Tampilkan
                                Semua</button>
                            <a href="add2.php?table=helper" class="btn btn-success">Tambah </a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <form method="POST" action="del_all.php" onsubmit="return confirmDeleteAll()">
            <input type="hidden" name="table" value="helper">
            <input type="hidden" name="redirect" value="helper.php">
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($data = mysqli_fetch_array($result)) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit.php?id=<?= $data['id'] ?>&table=helper"
                                    class="btn btn-warning">Edit</a>
                                <a href="delete.php?id=<?= $data['id'] ?>&table=helper" class="btn btn-danger"
