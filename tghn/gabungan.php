...
$query_tagihan = "
    ...
    FROM (
        SELECT 'BS01' AS sumber, pengguna, no_hp, jumlah_hm, harga_hm, total_tagihan, total_angsuran, sisa_tagihan FROM tb_tgbs01 WHERE pengguna = '$pengguna' AND no_hp = (
        SELECT no_hp FROM $table WHERE id = '$id'
    )
        UNION ALL
        SELECT 'BS02' AS sumber, pengguna, no_hp, jumlah_hm, harga_hm, total_tagihan, total_angsuran, sisa_tagihan FROM tb_tgbs02 WHERE pengguna = '$pengguna' AND no_hp = (
        SELECT no_hp FROM $table WHERE id = '$id'
    )
        UNION ALL
        SELECT 'BS03' AS sumber, pengguna, no_hp, jumlah_hm, harga_hm, total_tagihan, total_angsuran, sisa_tagihan FROM tb_tgbs03 WHERE pengguna = '$pengguna' AND no_hp = (
        SELECT no_hp FROM $table WHERE id = '$id'
    )
        UNION ALL
        SELECT 'BS04' AS sumber, pengguna, no_hp, jumlah_hm, harga_hm, total_tagihan, total_angsuran, sisa_tagihan FROM tb_tgbs04 WHERE pengguna = '$pengguna' AND no_hp = (
        SELECT no_hp FROM $table WHERE id = '$id'
    )
        UNION ALL
        SELECT 'BS05' AS sumber, pengguna, no_hp, jumlah_hm, harga_hm, total_tagihan, total_angsuran, sisa_tagihan FROM tb_tgbs05 WHERE pengguna = '$pengguna' AND no_hp = (
        SELECT no_hp FROM $table WHERE id = '$id'
    )
    ) AS combined
